...
import { Col, Row, Card, CardBody, CardTitle, Label, Input, Container, CardText } from 'reactstrap';
...
let filters = {
    type: ['Historie', 'Drikkelek', 'Fanmail', 'Sitat'],
    sorting: [
        {
            name: 'Nyeste',
            checked: true,
...
class Blog extends Component {
    ...
    handleFilter = e => {
        ...
        if (activeFilters.find(o => o === filter)) {
            ...
            this.setState(prevState => ({ activeFilters: [...prevState.activeFilters, filter] }));
        }
    };
    ...
    render() {
        ...
        let activePosts = posts.filter(
            o => activeFilters.includes(o.type) || !activeFilters.some(r => filters.type.includes(r))
        );
            ...
            <Container>
                <Row>
                    <Col style={{ textAlign: 'center', marginTop: 10 }}>
                        <h4>Velkommen til vår blogg!</h4>
                        <hr className="my-2" />
                        <div>
                            <p>
                                <i>
                                    Her vil du finne spennende historier, lekne drikkeleker, sitater blant verdens beste
                                    fyllikere og morsomme fanmails.
                                </i>
                            </p>
                            <p>
                                <i>
                                    Lek deg litt rundt, og gjerne send inn ett eller to innlegg du synes kan passe seg.
                                </i>
                            </p>
                            <p>
                                <i>Vi drikkes!</i>
